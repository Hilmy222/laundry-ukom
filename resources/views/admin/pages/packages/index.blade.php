        ...
        <div class="page-content dark:bg-zinc-700">
            ...
            <div class="container-fluid px-[0.625rem]">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.packages.create') }}" categories="button"
                        class="mb-6 text-white bg-[#3366FF] border-transparent btn hover:bg-gray-200"><i
                            class="mr-1 mdi mdi-plus"></i>Tambah Paket</a>
                </div>
                <div class="col-span-12 xl:col-span-6">
                    <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                        <div class="card-body border-b border-gray-100 dark:border-zinc-600">
                            <h6 class="mb-1 text-gray-700 text-15 dark:text-gray-100">Data Paket</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="w-full text-sm text-left text-gray-500 ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr
                                            ...
                                            <td class="px-6 py-3.5 dark:text-zinc-100">
                                                {{ $package->Outlet->nama_outlet }}
                                            </td>
                                            <td class="px-6 py-3.5 dark:text-zinc-100 flex gap-2">
                                                <a href="{{ route('admin.packages.edit', $package->id) }}" class="rounded-md px-3 py-1.5 bg-[#3366FF]"><i
