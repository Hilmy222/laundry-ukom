                                ...
                                <div class="col-span-12 lg:col-span-6">
                                    <form action="{{ route('admin.users.store') }}" method="POST">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input name="alamat_penggguna"
                                                class="w-full placeholder:text-13 text-13 py-1.5 rounded border-gray-100 focus:border focus:border-violet-50 focus:ring focus:ring-violet-500/20 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 placeholder:text-gray-800 dark:text-zinc-100"
                                                type="text" placeholder="Masukkan Username" id="username" required>
                                        </div>
                                        <div class="mb-4">
                                            <label for="password"
                                            ...
                                            <input name="alamat_penggguna"
                                                class="w-full placeholder:text-13 text-13 py-1.5 rounded border-gray-100 focus:border focus:border-violet-50 focus:ring focus:ring-violet-500/20 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 placeholder:text-gray-800 dark:text-zinc-100"
                                                type="password" placeholder="Masukkan Password" id="password" required>
                                        </div>
                                        <div class="mb-4">
                                            <label for="username"
                                                class="block mb-2 font-medium text-gray-700 dark:text-gray-100">Role</label>
                                            <input name="alamat_penggguna"
                                                class="w-full placeholder:text-13 text-13 py-1.5 rounded border-gray-100 focus:border focus:border-violet-50 focus:ring focus:ring-violet-500/20 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 placeholder:text-gray-800 dark:text-zinc-100"
                                                type="text" placeholder="Pilih Role" id="role" required>
                                        </div>
