                                    ...
                                    <form action="{{ route('admin.customers.update', $customers->id) }}" method="POST">
                                        ...
                                        <div class="mb-4">
                                            <label for="example-text-input"
                                                ...
                                                <input type="text"  value="{{ old('nama', $customers->nama) }}"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input value="{{ old('alamat', $customers->alamat) }}"
                                                class="w-full placeholder:text-13 text-13 py-1.5 rounded border-gray-100 focus:border focus:border-violet-50 focus:ring focus:ring-violet-500/20  dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 placeholder:text-gray-800 dark:text-zinc-100"
                                                type="text" placeholder="Masukkan Alamat" name="alamat">
                                        </div>
                                        <div class="mb-4">
                                            <div class="mb-3">
                                                <label class="block mb-2 font-medium text-gray-700 dark:text-zinc-100">Jenis Kelamin</label>
                                                <select name="jenis_kelamin" class="dark:bg-zinc-800 dark:border-zinc-700 w-full rounded border-gray-100 py-2.5 text-sm text-gray-500 focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:text-zinc-100">
                                                    ...
                                                    <option value="Laki-Laki" {{ old('jenis_kelamin', $customers->jenis_kelamin ?? '') == 'Laki-Laki' ? 'selected' : '' }}>Laki-Laki</option>
                                                    <option value="Perempuan" {{ old('jenis_kelamin', $customers->jenis_kelamin ?? '') == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            <label for="example-text-input"
                                                ...
                                                Telepon</label>
                                            <input value="{{ old('tlp' , $customers->tlp) }}"
                                                class="w-full placeholder:text-13 text-13 py-1.5 rounded border-gray-100 focus:border focus:border-violet-50 focus:ring focus:ring-violet-500/20  dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 placeholder:text-gray-800 dark:text-zinc-100"
                                                type="text" placeholder="Masukkan Nomor Telepon" id="tlp" name="tlp">
                                        </div>
                                        <button type="submit" class="px-4 py-2 bg-blue-500 rounded">Simpan</button>
                                    </form>
                                </div>
                            </div>
                        </div>
